...
4. Отсортируйте отслеженные пакеты по их исходному IP-адресу; для этого щелкните по
   ...
   1. Какие поля IP-дейтаграммы всегда изменяются от одной дейтаграммы к
      ...
      - Identification, Header checksum, Time to live

<img src="images/ft4.png" width=700 />
<img src="images/ft5.png" width=700 />
   ...
   2. Какие поля не меняются? Какие поля должны оставаться неизменными? Какие
      ...
      - поля выше точно должны оставаться неизменными (так как задали в traceroute размер пакета, фильтр по исходному ip, протокол тоже не меняется)
      - TTL должен меняться; Header checksum, так как ttl меняется; Identification
      - видно на фото выше
...
6. Остаются ли эти значения (Identification и TTL) неизменными во всех сообщениях
   ...
   - отличаются от тех, которые были отправлены; обратно ttl начинается с 64, Identification тоже разные у всех 3 пакетов

<img src="images/ft8.png" width=700 />
<img src="images/ft9.png" width=700 />
<img src="images/ft10.png" width=700 />
...
8. **Фрагментация**. Остановите захват пакетов в Wireshark. Измените размер пакета
   ...
   1. Было ли это сообщение фрагментировано между двумя или более IP-дейтаграммами? 
      ...
      - было разбито на 3 фрагмента

<img src="images/ft11.png" width=700 />

   2. Какие поля IP-заголовка изменяются в разных фрагментах?
      - Total length, Fragment offset, Header checksum

<img src="images/ft12.png" width=700 />
<img src="images/ft13.png" width=700 />
