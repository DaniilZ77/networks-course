...
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   - этот протокол живет на уровне ip, порты живут на транспортном уровне
3. Рассмотрите один из ping-запросов, отправленных вашим хостом. Каковы ICMP-тип и кодовый
   ...
   - Checksum, Identififer, Sequence number
...
1. Рассмотрите ICMP-пакет с эхо-запросом на вашем скриншоте. Отличается ли он от ICMP-пакетов
   ...
   - ничем не отличается, такой же запрос

<img src="images/traceroute1.png" width=600 />
...
2. Рассмотрите на вашем скриншоте ICMP-пакет с сообщением об ошибке. В нем больше полей,
   ...
   - внутри icmp пакета содержится ip пакет, который не дошел, также появилось новое поле unused

<img src="images/traceroute2.png" width=600 />
...
3. Рассмотрите три последних ICMP-пакета, полученных исходным хостом. Чем эти пакеты
   ...
   - пакеты с типом Reply (0)
   - хватило ttl, чтобы дойти до конца

<img src="images/traceroute3.png" width=600 />
...
4. Есть ли такой канал, задержка в котором существенно превышает среднее значение? Можете
   ...
   - да, 9-10
   - 9 - Samarskaya oblast', 10 - New York City (nyc)

<img src="images/traceroute4.png" width=600 />
...
#### Демонстрация работы
<img src="images/whoami.png" width=600 />
