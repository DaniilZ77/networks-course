...
#### Демонстрация работы
 ...
 <img src="images/create_cactus.png" width=500 />
 <img src="images/get_cactuses.png" width=500 />
 <img src="images/get_cactus.png" width=500 />
 <img src="images/update_cactus.png" width=500 />
 <img src="images/delete_cactus.png" width=500 />
...
<img src="images/set_cactus_image.png" width=500 />
<img src="images/get_cactus_image.png" width=500 />
...
#### Решение
$\dfrac{F}{R_1} + \dfrac{L}{R_2} + \dfrac{L}{R_3} = 200с + L \dfrac{5}{6 \times 10^6}$, где $L$ - размер пакета, $F$ - размер файла. Складывается из времени, затраченного на прохождение первого канала, который имеет наименьшую скорость, и прохождение одним пакетом второго и третьего канала.
...
Одновременно пользователей максимально может быть $\dfrac{2000}{100} = 20$

$\sum_{i=12}^{20} \binom{60}{i} p^{i} (1 - p)^{60-i} = 0.5465568071943473082017033417897432858968993440839397015552$
...
#### Решение
Задержка для 3 каналов и $\dfrac{X}{S}$ пакетов равна $(2 + \dfrac{X}{S}) \dfrac{(80 + S)}{R}$

Берем производную и получаем, что минимум при $S = 2 \times \sqrt{10 X}$
...
$d = \dfrac{I \cdot L}{R (1 – I)} + \dfrac{L}{R} = \dfrac{L}{R} \dfrac{1}{1 - I}$

Общая задержка получается домножением $\dfrac{L}{R}$ на $\dfrac{1}{1 - I}$, чем интенсивнее трафик, тем получается выше общая задержка.
